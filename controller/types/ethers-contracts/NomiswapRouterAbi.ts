...
export interface NomiswapRouterAbiInterface extends utils.Interface {
  functions: {
...
export interface NomiswapRouterAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NomiswapRouterAbiInterface;
